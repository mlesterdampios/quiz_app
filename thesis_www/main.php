...
?>
<script>
function validateForm() {var y = document.forms["form"]["name"].value;	var letters = /^[A-Za-z]+$/;if (y == null || y == "") {alert("Name must be filled out.");return false;}var z =document.forms["form"]["college"].value;if (z == null || z == "") {alert("section must be filled out.");return false;}var x = document.forms["form"]["email"].value;var atpos = x.indexOf("@");
...
<div class="row">
<div class="col-lg-6">
<span class="logo">HeroLearn</span></div>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your section" class="form-control input-md" type="text">
...
<!-- <div class="modal fade title1" id="developers"> -->
    <!-- <div class="modal-dialog"> -->
      ...
      <div class="row">
      <div class="col-md-4">
       <img src="image/burn.jpg" width=100 height=100 alt="" class="img-rounded">
       </div>
       <div class="col-md-5">
      <a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">John Bhurn Delgado Conmigo</a>
      <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">0935 434 1842</h4>
